...
document.getElementById('toggle-drawing').addEventListener('click', toggleDrawing);
document.getElementById('drawing-color').addEventListener('change', handleColorChange);
document.getElementById('drawing-thickness').addEventListener('input', handleThicknessChange);